...
-   [ ] Crear y mejorar tests e2e en Cypress con flujos reales de usuario para cada transporte.
-   [ ] Añadir tests unitarios para los servicios de favoritos, displays y lógica reutilizable.
-   [ ] Añadir workflow de CI (GitHub Actions) que ejecute lint, build y tests en cada push/PR.

## 4. Limpieza Técnica y Mantenimiento

-   [ ] Revisar y eliminar rutas, componentes o funciones huérfanas (p. ej. /euskotren-add-stop si ya no es accesible).
-   [ ] Documentar servicios clave y actualizar los comentarios en las partes más importantes del código.

## 5. Internacionalización (i18n)

-   [ ] Auditar todos los textos y archivos de idioma. Corregir textos faltantes o hardcodeados en la interfaz.

## 6. Accesibilidad

-   [ ] Revisar contraste de colores, botones y soporte a lectores de pantalla.
